...
The final and most major improvement LSTM could do is to train LSTM on a bigger dataset. This would result in more examples that LSTM could learn from and perform better. A 1,000-3,000 large session dataset could be tested for increased performance over SVC or a similar baseline.
